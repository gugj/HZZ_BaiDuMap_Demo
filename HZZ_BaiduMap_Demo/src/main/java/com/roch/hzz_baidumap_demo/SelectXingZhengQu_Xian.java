 ...
 */
public class SelectXingZhengQu_Xian extends CommonBaseActivity implements AdapterView.OnItemClickListener {
    ...
    public void initData() {
        ...
        MyApplication.getInstance().getHttpUtilsInstance().post(SelectXingZhengQu_Xian.this, URLs.XingZhengQu, params, null, MyConstans.FIRST);
        System.out.println("河道资料高级查询页面请求县级行政区的网址为：==" + URLs.XingZhengQu);
    }
