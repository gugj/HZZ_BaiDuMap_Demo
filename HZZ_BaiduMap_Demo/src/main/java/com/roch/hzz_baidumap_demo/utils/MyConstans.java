...
public class MyConstans {
	...
	public static final int PAGECOUNT_NUMBER =  15;//每页加载的条数
	public static final boolean IS_DEVELOP_MODE = true;
	public static final String SUCCESS = "success";
	public static final String ERROR = "error";
	
	/**
	 * 贫困户帮扶记录请求网上数据时回调的标志位flag
	 */
	public static final int BangFuJiLu = 0;
	/**
	 * 贫困户帮扶记录请求网上数据时回调的标志位flag
	 */
	public static final int BangFuJiLu_Id = 23;
