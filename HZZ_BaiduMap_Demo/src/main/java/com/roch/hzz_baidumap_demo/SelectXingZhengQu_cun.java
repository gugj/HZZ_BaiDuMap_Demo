 ...
 */
public class SelectXingZhengQu_cun extends CommonBaseActivity implements AdapterView.OnItemClickListener {
    ...
    public void initData() {
       ...
       Ad_Cd select_ad_cd= (Ad_Cd) intent.getSerializableExtra("select_ad_cd");
        params.clear();
        params.put("adCd", select_ad_cd.getId());
        MyApplication.getInstance().getHttpUtilsInstance().post(SelectXingZhengQu_cun.this, URLs.XingZhengQu, params, null, MyConstans.FIRST);
        System.out.println("河道资料高级查询页面请求村级行政区的网址为：==" + URLs.XingZhengQu);
    }
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ShowToast(ad_cds.get(position).getAdNm());
...
//        MyApplication.getInstance().finishActivity(SelectXingZhengQu_xiang.class);
