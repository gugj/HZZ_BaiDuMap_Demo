...
import com.roch.hzz_baidumap_demo.holder.Action;
...
/**
 * Created by GuGJ on 2017/7/10/0010.
 */
public abstract class MyRecyclerAdapter<T> extends RecyclerView.Adapter<BaseRecyclerViewHolder<T>> {
    ...
    public MyRecyclerAdapter(Context context, T[] data) {
        this(context, Arrays.asList(data));
    }

    public MyRecyclerAdapter(Context context, List<T> data) {
        mContext = context;
        initStatusView(context);
        this.mData = data;
    ...
    public BaseRecyclerViewHolder<T> onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == HEADER_TYPE) {
            ...
            return new BaseRecyclerViewHolder<>(mStatusView);
        } else
            return onCreateBaseViewHolder(parent, viewType);
    }

    public abstract BaseRecyclerViewHolder<T> onCreateBaseViewHolder(ViewGroup parent, int viewType);
