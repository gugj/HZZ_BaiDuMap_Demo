            ...
            for (WalkingRouteLine.WalkingStep step : mRouteLine.getAllStep()) {
                ...
                if (step.getEntrance() != null) {
                    ...
                    overlayList.add((new MarkerOptions())
                               .position(step.getEntrance().getLocation()) // 位置
                               .rotate((360 - step.getDirection())) // 旋转
                               .zIndex(10) // 缩放级别
                               .anchor(0.5f, 0.5f)
                               .extraInfo(b) // 携带信息
        ...
        if (mRouteLine.getAllStep() != null && mRouteLine.getAllStep().size() > 0) {
            ...
            for (WalkingRouteLine.WalkingStep step : mRouteLine.getAllStep()) {
                ...
                if (watPoints != null) {
                    ...
                    overlayList.add(new PolylineOptions().points(points).width(10).color(getLineColor() != 0 ? getLineColor() : Color.argb(178, 0, 78, 255)).zIndex(0));
