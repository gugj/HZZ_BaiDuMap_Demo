...
public class GeometryDemo extends Activity {
    ...
    public void addCustomElementsDemo() {
        ...
        colorValue.add(Integer.valueOf(Color.GREEN));
        colorValue.add(Integer.valueOf(Color.RED));
        colorValue.add(Integer.valueOf(Color.BLACK));
        OverlayOptions ooPolyline1 = new PolylineOptions().width(10)
                .color(Integer.valueOf(0xAAFF0000)).points(points1).colorsValues(colorValue);
        ...
        OverlayOptions ooCircle = new CircleOptions()
                .fillColor(Integer.valueOf(Color.GREEN))
                .center(llCircle)
                .stroke(new Stroke(5, Integer.valueOf(Color.BLUE)))
                .radius(1400);
        mBaiduMap.addOverlay(ooCircle);

        LatLng llDot = new LatLng(39.98923, 116.397428);
        OverlayOptions ooDot = new DotOptions()
                .center(llDot).radius(6)
                .color(Integer.valueOf(Color.GREEN));
        ...
        OverlayOptions ooPolygon = new PolygonOptions()
                .points(pts)
                .stroke(new Stroke(5, Integer.valueOf(Color.GREEN)))
                .fillColor(Integer.valueOf(Color.BLUE));
        mBaiduMap.addOverlay(ooPolygon);

        // 添加文字
        LatLng llText = new LatLng(39.86923, 116.397428);
        OverlayOptions ooText = new TextOptions()
                .bgColor(Integer.valueOf(Color.GREEN))
                .fontSize(24)
                .fontColor(Integer.valueOf(Color.GREEN))
                .text("百度地图SDK")
                .rotate(-30)
                .position(llText);
